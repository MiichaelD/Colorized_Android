...
public class TutoState extends BaseState {
  ...
  public void resize(float width, float height) {
    ...
    float boardPixels = pGame.mRectFs[0].width() / Constants.BOARD_SIZES[ProgNPrefs.getIns().getDifficulty()];
  ...
  public boolean touch(MotionEvent me) {
    ...
    if (action == MotionEvent.ACTION_UP ||
      ...
      switch (mInnerState) {
        case INIT:
          mInnerState = innerStates.FIRST;
          break;
        case FIRST:
          mInnerState = innerStates.SEC;
          break;
        case SEC:
          mInnerState = innerStates.THIRD;
          break;
        case THIRD:
          mInnerState = innerStates.FOURTH;
          break;
        case FOURTH:
          mInnerState = innerStates.FIFTH;
          break;
        case FIFTH:
          mInnerState = innerStates.FINAL;
          break;
        case BACK:
          mInnerState = mPreState;
          break;
        case FINAL:
          saveTutorialFinish();
