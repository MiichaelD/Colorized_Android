...
public class ServerConn{
	...
	public static boolean isNetworkAvailable() {
		boolean ret;
		ConnectivityManager connectivityManager = (ConnectivityManager) GameActivity.getIns().getSystemService(Context.CONNECTIVITY_SERVICE);
		NetworkInfo activeNetworkInfo = connectivityManager.getActiveNetworkInfo();
		ret = activeNetworkInfo != null && activeNetworkInfo.isConnectedOrConnecting();
		if(Const.D & !ret){
			Log.e(TAG+"-srvConn","there is no network Available ");	
		}
		return ret;
	}
	...
	public static boolean haveNetworkConnection() {
		ConnectivityManager cm = (ConnectivityManager) GameActivity.getIns().getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	public static HttpURLConnection Connect(int mMethod, String mUrl, String query)throws Exception{
		...
		if(Const.D){
			Log.v(TAG+"-srvConn","Opening Connection("+mMethod+") to url: "+mUrl+"?"+query);	
		}
